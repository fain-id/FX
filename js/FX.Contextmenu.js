(function($){
	...
	function display(index, trigger, e, options) {
		...
		var content = '<ul id="navTabCM"><li rel="reload"><i class="fa fa-refresh"></i> 刷新标签页</li><li rel="closeOther"><i class="fa fa-times"></i> 关闭其它标签页</li><li rel="closeAll"><i class="fa fa-times"></i> 关闭全部标签页</li></ul>';
